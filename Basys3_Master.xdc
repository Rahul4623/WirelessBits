## ============================================================
## Basys3 Constraint File — UART Transmitter Design
...
## ------------------------------------------------------------
## Buttons
##   btn0 (BTNC — center) = synchronous reset
##   btn1 (BTNU — up)     = transmit trigger (debounced)
## ------------------------------------------------------------
...
##   Connect TxD here for Tera Term / serial terminal on PC
## ------------------------------------------------------------
set_property PACKAGE_PIN A18 [get_ports TxD]
set_property IOSTANDARD LVCMOS33 [get_ports TxD]

## ------------------------------------------------------------
## Pmod Header JA — Debug signals (observable on oscilloscope
##   or logic analyser; also fed to HC-05/HC-06 Bluetooth module
##   on JA for Serial Bluetooth Terminal app)
##
