...
## Hardware Used
HardwarePurpose
Digilent Basys3 FPGA boardRuns the UART transmitter design, has onboard BluetoothUSB cableConnect Basys3 to laptop - for programming and UART outputLaptop with Vivado + Tera TermFlash bitstream, monitor UART output on PCAndroid/iOS phoneReceive UART output wirelessly via Bluetooth
...
Project Files
FileDescription-
top.vTop-level module - connects all sub-modules
